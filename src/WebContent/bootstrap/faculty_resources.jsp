 ...
 <div class="row">
            <div class="box">
                ...
                <div class="col-lg-12">
                    ...
                    <!-- Book Form -->
                    <form name="faculty_Book_select" method="post" action="../Redirect_To_Search_Book1">
                        <div class="row">
                    ...
                    <form name="faculty_ConferencePaper_select" method="post" action="../Conference_Retrieve1">
                        <div class="row">
                    ...
                    <!-- ConferencePaper Form Ends-->
                     ...
                     <!-- Journal Form -->
                    <form name="faculty_Journal_select" method="post" action="../Journal_Retrieve1">
                        <div class="row">
                    ...
                    <!-- Room Form -->
                    <form name="faculty_Room_select" method="post" action="../Room_Retrieve1">
                        <div class="row">
                    ...
                    <!-- Camera Form -->
                    <form name="faculty_Camera_select" method="post" action="../Camera_Retrieve1">
                        <div class="row">
                    ...
                    <!-- MY RESOURCES STARTS-->
                    <form name="faculty_Camera_select" method="post" action="../My_Resources1">
                        <div class="row">
  ...
  {
  %>
<center><b>Your account has been Suspended. Please pay your dues</b><a href="./bootstrap/faculty.jsp">Go Back</a></center>  
