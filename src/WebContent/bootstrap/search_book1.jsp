 ...
 <div class="row">
            <div class="box">
                ...
                <div class="col-lg-12">
                    ...
                    <!-- Search Book Form -->
                    <form name="faculty_Book_select" method="post" action="Book_Retrieve1">
                        <div class="row">
                           <div class="form-group col-lg-4" align="center">
                            ...
                            <!--<div class="form-group col-lg-12">-->
                                ...
                                <input type="submit" name="book_search" class="btn btn-default" value="Search Book" style="width:200px"/>
                            <!--</div>-->
                             </div>
                        </div>
                    </form>
                    <!-- Search Book Form Ends-->
