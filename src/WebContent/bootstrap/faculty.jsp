...
//Faculty faculty1=(Faculty)request.getAttribute("faculty");

System.out.println("Hello I am Here in JSP page "+faculty.getFname());
%>
            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">
                        <strong><label>WELCOME <%=faculty.getFname()%></label></strong>
                    </h2>
                    <hr>
