 ...
 <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <form id="journal_checkout" action="Faculty_Journal_Checkout" method="post">
                        <div class="row">
                        	<!--  <div class="form-group col-lg-4">-->
                                <center><label>Select a Journal</label></center>
                                <br>
                                <table style="margin:0 auto;text-align: left;" >
                                <% int i=0;
            					while(i<journal.length){ %>
            					<tr>
                                <td width="3%"><input type="radio" name="journal_list" class="form-control" value="<%=journal[i].getResource_Id() %>"></td>
                                <td width="90%"><%=journal[i].getTitle()%></td>
                                </tr>                                
                                <%++i;} %>
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <center><input type="submit" class="btn btn-default" value="Checkout Journal"></center>
                            </div>
