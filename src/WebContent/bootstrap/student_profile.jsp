...
//String timekk= s.format(student.getDob());
//String timekk = new SimpleDateFormat("yyyy-MM-dd").format(student.getDob());
 ...
 <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <form role="form" name="user_profile" action="../Update_Student_Profile" method="post">
                        <div class="row">
                            <div class="form-group col-lg-4">
                                <label>First Name</label>
                                <input type="text" name="fname" class="form-control" value="<%=student.getFname()%>">
                        
                            <br>
                                <label>Last Name</label>
                                <input type="text" name="lname" class="form-control" value="<%=student.getLname()%>">
                           <br><br>
                           ...
                           <br><br>
                            ...
                            <br>
                                <label>Street</label>
                                <input type="text" name="street" class="form-control" value="<%=student.getStreet()%>">
                            <br>
                            
                                <label>Postcode</label>
                                <input type="text" name="postcode" class="form-control" value="<%=student.getPostcode()%>">
                            
                            <br>
                            
                                <label>Nationality</label>
                                <input type="text" name="nationality" class="form-control" value="<%=student.getNationality()%>">
                            
                            <br>
                            </div>
                            <div class="form-group col-lg-4">
                                <label>Contact Number</label>
                                <input type="text" name="contact" class="form-control" value="<%=student.getPhone_no()%>">
                            
                            <br>
                            
                                <label>Alternate Contact</label>
                                <input type="text" name="alt_contact" class="form-control" value="<%=student.getAlt_phone()%>">
                            
                            <br>
                            <label>State</label>
                                <input type="text" name="state" class="form-control" value="<%=student.getState()%>">
                            <br>    
